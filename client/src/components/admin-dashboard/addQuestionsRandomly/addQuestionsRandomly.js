          ...
          <div className="row  mt-4-5 justify-content-md-center">
            <div className="col-md-6">
              <h5>
                <ul>
                  <li>
                    Enter the number of questions of all difficulty levels you
                    want to add to this quiz:
                  </li>
                </ul>
              </h5>
            </div>
...
export default connect(mapStateToProps, { addQRandomly })(AddQuestionsRandomly);
